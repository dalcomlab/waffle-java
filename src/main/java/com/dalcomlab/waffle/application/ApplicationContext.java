...
public class ApplicationContext implements ServletContext {
    ...
    private WelcomeFileManager welcomeFileManager;
    ...
    // private ApplicationClassLoader classLoader = new ApplicationClassLoader(Thread.currentThread().getContextClassLoader());
    //private ApplicationClassLoader classLoader = new ApplicationClassLoader();
    ...
    public ApplicationContext(String contextName, String contextPath) {
        ...
        this.resourceManager = new ResourceManager(this, contextPath);
        this.sessionManager = new SessionManager(this);
        this.mimeManager = new MimeManager(this);
        this.welcomeFileManager = new WelcomeFileManager(this);
        this.errorPageManager = new ErrorPageManager(this);
        this.filterChainManager = new FilterChainManager(this);
    }
    ...
    public void initialize() throws Exception {
        ...
        this.mimeManager.initialize();
        this.welcomeFileManager.initialize();
        this.errorPageManager.initialize();
        this.filterChainManager.initialize();

        listenerManager.fireContextInitialized();
    }
    ...
    public void destroy() throws Exception {
        ...
        this.mimeManager.destroy();
        this.welcomeFileManager.destroy();
        this.errorPageManager.destroy();
        this.filterChainManager.destroy();
        listenerManager.fireContextDestroyed();
    }

    /**
     * Gets the listener manager corresponding to this context.
     *
     * @return
     */
    ...
    /**
     * Gets the servlet manager corresponding to this context.
     *
     * @return
     */
    ...
    /**
     * Gets the filter manager corresponding to this context.
     *
     * @return
     */
    ...
    /**
     * Gets the session manager corresponding to this context.
     *
     * @return
     */
     ...
     *
     * <p>The context path is the portion of the channel URI that is used
     * to listEntries the context of the channel. The context path always comes
     * first in a channel URI. If this context is the "root" context
     ...
     * will return the actual context path used by the channel and it may
    ...
    public String getMimeType(String file) {
        ...
        return mimeManager.getMimeType(extension);
    }
    ...
    public RequestDispatcher getRequestDispatcher(String path) {
        ...
        if (!path.startsWith("/")) {
            String message = MessageFormat.format("The path must start with a '/'.", null);
    ...
    public RequestDispatcher getNamedDispatcher(String name) {
        ServletDelegate servlet = servletManager.getServletByName(name);
        if (servlet != null) {

        }

        return new RequestDispatcherImpl(this, name);
    }
    ...
    public Enumeration<Servlet> getServlets() {
        return servletManager.getServlets();
    }
    ...
    public Enumeration<String> getServletNames() {
        return servletManager.getServletNames();
    }
    ...
    public void setAttribute(String name, Object object) {
        ...
        if (object == null) {
            ...
            Object value = attributes.setAttribute(name, object);
            if (value != null) {
                listenerManager.fireServletContextAttributeReplaced(name, value);
            } else {
                listenerManager.fireServletContextAttributeAdded(name, object);
            }
        }
    }
    ...
    public void removeAttribute(String name) {
        ...
        if (value != null) {
            ...
            listenerManager.fireServletContextAttributeRemoved(name, value);
        }
    }
    ...
    public ServletRegistration.Dynamic addServlet(String servletName, String className) {
        return servletManager.addServlet(servletName, className);
    }
    ...
    public ServletRegistration.Dynamic addServlet(String servletName, Servlet servlet) {
        return servletManager.addServlet(servletName, servlet);
    }
    ...
    public ServletRegistration.Dynamic addServlet(String servletName,
        ...
        return servletManager.addServlet(servletName, servletClass);
    }
    ...
    public ServletRegistration.Dynamic addJspFile(String servletName, String jspFile) {
        return servletManager.addJspFile(servletName, jspFile);
    }
    ...
    public <T extends Servlet> T createServlet(Class<T> clazz) throws ServletException {
        return servletManager.createServlet(clazz);
    }
    ...
    public ServletRegistration getServletRegistration(String servletName) {
        return servletManager.getServletRegistration(servletName);
    }
    ...
    public Map<String, ? extends ServletRegistration> getServletRegistrations() {
        return servletManager.getServletRegistrations();
    }
    ...
    public FilterRegistration.Dynamic addFilter(String filterName, String className) {
        return filterManager.addFilter(filterName, className);
    }
    ...
    public FilterRegistration.Dynamic addFilter(String filterName, Filter filter) {
        return filterManager.addFilter(filterName, filter);
    }
    ...
    public FilterRegistration.Dynamic addFilter(String filterName,
        ...
        return filterManager.addFilter(filterName, filterClass);
    }
    ...
    public <T extends Filter> T createFilter(Class<T> clazz) throws ServletException {
        return filterManager.createFilter(clazz);
    }
    ...
    public FilterRegistration getFilterRegistration(String filterName) {
        return filterManager.getFilterRegistration(filterName);
    }
    ...
    public Map<String, ? extends FilterRegistration> getFilterRegistrations() {
        return filterManager.getFilterRegistrations();
    }
    ...
    public void addListener(String className) {
        listenerManager.addListener(className);
    }
    ...
    public <T extends EventListener> T createListener(Class<T> clazz) throws ServletException {
        return listenerManager.createListener(clazz);
    }


    /**
     * Gets the <code>&lt;jsp-configure&gt;</code> related configuration
     ...
     *
     * @return the <code>&lt;jsp-configure&gt;</code> related configuration
     * that was aggregated from the <code>web.xml</code> and
     * <code>web-fragment.xml</code> descriptor files of the web application
    ...
    /**
     * Gets the channel character encoding that are supported by default for
     * this <tt>ServletContext</tt>. This method returns null if no channel
     ...
     * container).
     *
     * @return the channel character encoding that are supported by default for
     * this <tt>ServletContext</tt>
     * @throws UnsupportedOperationException if this ServletContext was
     *                                       passed to the {@link ServletContextListener#contextInitialized} method
     *                                       of a {@link ServletContextListener} that was neither declared in
    ...
    /**
     * Sets the channel character encoding for this ServletContext.
     *
     * @param encoding channel character encoding
     * @throws IllegalStateException         if this ServletContext has already
     *                                       been initialized
     * @throws UnsupportedOperationException if this ServletContext was
     *                                       passed to the {@link ServletContextListener#contextInitialized} method
    ...
    public ServletDelegate getServlet(Path path) {
        return servletManager.getServlet(path);
    }
    ...
    public FilterDelegate[] getFilters(Path path, DispatcherType type) {
        return filterManager.getFilters(path, type);
    }
    ...
    public FilterDelegate[] getFilters(String servletName) {
        return filterManager.getFilters(servletName);
    }
    ...
    public Dispatch dispatch(String path, ServletRequest request, ServletResponse response)  {
        ...
        String contextPath = "/" + getServletContextName();
        if (!path.startsWith(contextPath)) {
            path = contextPath + path;
        }


        System.out.println("search servlet : " + path);
        String servlet = path.replaceFirst("/" + this.getServletContextName(), "");
        if (servlet.indexOf('?') > 0)
            servlet = servlet.substring(0, servlet.indexOf('?'));
        Mapping<ServletDelegate> mapping = servletManager.matches(new Path(servlet));
        ...
        if (mapping == null) {
            System.out.println("the servlet not found");
            servletPath = "*.";
        } else {
            System.out.println("the servlet found");
            servletPath = mapping.getPattern();
        }
        ...
        if (servletPath.endsWith("/*")) {
            ...
            servletPath = path;
            if (path.indexOf('?') > 0)
                servletPath = path.substring(0, path.indexOf('?'));
        ...
        if (mapping != null) {
            servletdelegate = mapping.getInstance();
        }

        FilterChainDelegate filterChain = this.filterChainManager.createFilterChain(servletdelegate, path, request.getDispatcherType());

        return new Dispatch(filterChain, request, response, requestURI, contextPath, servletPath, pathInfo, queryString);
