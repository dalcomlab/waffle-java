 ...
 */
public class ResponseAdaptorDebug implements HttpServletResponse {
     ...
     * @param response
     */
    public ResponseAdaptorDebug(HttpServletResponse response) {
    ...
    public void addCookie(Cookie cookie) {
        System.out.println("HttpServletResponse API : addCookie(Cookie cookie)");
        if (response != null) {
    ...
    public boolean containsHeader(String name) {
        System.out.println("HttpServletResponse API : containsHeader(String name) : " + name);
        if (response != null) {
    ...
    public String encodeURL(String url) {
        System.out.println("HttpServletResponse API : encodeURL(String url) : " + url);
        if (response != null) {
    ...
    public String encodeRedirectURL(String url) {
        System.out.println("HttpServletResponse API : encodeRedirectURL(String url) : " + url);
        if (response != null) {
    ...
    public void sendError(int sc, String msg) throws IOException {
        System.out.println("HttpServletResponse API : sendError(int sc, String msg)");
        if (response != null) {
    ...
    public void sendError(int sc) throws IOException {
        System.out.println("HttpServletResponse API : sendError(int sc) : " + sc);
        if (response != null) {
     ...
     * the current channel URI. If the location is relative with a leading
    ...
    public void sendRedirect(String location) throws IOException {
        System.out.println("HttpServletResponse API : sendRedirect(String location) : " + location);
        if (response != null) {
    ...
    public void setDateHeader(String name, long date) {
        System.out.println("HttpServletResponse API : setDateHeader(String name, long date)");
        if (response != null) {
    ...
    public void addDateHeader(String name, long date) {
        System.out.println("HttpServletResponse API : addDateHeader(String name, long date)");
        if (response != null) {
    ...
    public void setHeader(String name, String value) {
        System.out.println("HttpServletResponse API : setHeader(String name, String value)");
        if (response != null) {
    ...
    public void addHeader(String name, String value) {
        System.out.println("HttpServletResponse API : addHeader(String name, String value)");
        if (response != null) {
            System.out.println("---- header name :" + name);
            System.out.println("---- header value :" + value);
    ...
    public void setIntHeader(String name, int value) {
        System.out.println("HttpServletResponse API : setIntHeader(String name, int value) : [" + name + ", " + value + "]");
        if (response != null) {
    ...
    public void addIntHeader(String name, int value) {
        System.out.println("HttpServletResponse API : addIntHeader(String name, int value) : [" + name + ", " + value + "]");
        if (response != null) {
    ...
    public void setStatus(int sc) {
        System.out.println("HttpServletResponse API : setStatus(int sc) : " + sc);
        if (response != null) {
    ...
    public void setStatus(int sc, String sm) {
        System.out.println("HttpServletResponse API : setStatus(int sc, String sm) : [" + sc + ", " + sm + "]");
        if (response != null) {
    ...
    public int getStatus() {
        System.out.println("HttpServletResponse API : getStatus()");
        if (response != null) {
    ...
    public String getHeader(String name) {
        System.out.println("HttpServletResponse API : getHeader(String name) : " + name);
        if (response != null) {
    ...
    public Collection<String> getHeaders(String name) {
        System.out.println("HttpServletResponse API : getHeaders(String name) : " + name);
        if (response != null) {
    ...
    public Collection<String> getHeaderNames() {
        System.out.println("HttpServletResponse API : getHeaderNames()");
        if (response != null) {
     ...
     * consulted, in decreasing order of priority: per channel, perweb-app
     ...
     * Per-channel, the charset for the response can be specified explicitly
    ...
    public String getCharacterEncoding() {
        System.out.println("HttpServletResponse API : getCharacterEncoding()");
        if (response != null) {
    ...
    public String getContentType() {
        System.out.println("HttpServletResponse API : getContentType()");
        if (response != null) {
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        System.out.println("HttpServletResponse API : getOutputStream()");
        if (response != null) {
    ...
    public PrintWriter getWriter() throws IOException {
        System.out.println("HttpServletResponse API : getWriter()");
        if (response != null) {
    ...
    public void setCharacterEncoding(String charset) {
        System.out.println("HttpServletResponse API : setCharacterEncoding(String charset) : " + charset);
        if (response != null) {
    ...
    public void setContentLength(int len) {
        System.out.println("HttpServletResponse API : setContentLength(int len) : " + len);
        if (response != null) {
    ...
    public void setContentLengthLong(long len) {
        System.out.println("HttpServletResponse API : setContentLengthLong(long len) : " + len);
        if (response != null) {
    ...
    public void setContentType(String type) {
        System.out.println("HttpServletResponse API : setContentType(String type) : " + type);
        if (response != null) {
    ...
    public void setBufferSize(int size) {
        System.out.println("HttpServletResponse API : setBufferSize(int size) : " + size);
        if (response != null) {
    ...
    public int getBufferSize() {
        System.out.println("HttpServletResponse API : getBufferSize()");
        if (response != null) {
    ...
    public void flushBuffer() throws IOException {
        System.out.println("HttpServletResponse API : flushBuffer()");
        if (response != null) {
    ...
    public void resetBuffer() {
        System.out.println("HttpServletResponse API : resetBuffer()");
        if (response != null) {
    ...
    public boolean isCommitted() {
        System.out.println("HttpServletResponse API : isCommitted()");
        if (response != null) {
            System.out.println("---- return :" + response.isCommitted());
    ...
    @Override
    public void reset() {
        System.out.println("HttpServletResponse API : reset()");
        if (response != null) {
            response.reset();
        }
    }
    ...
    public void setLocale(Locale loc) {
        System.out.println("HttpServletResponse API : setLocale(Locale loc)");
        if (response != null) {
    ...
    public Locale getLocale() {
        System.out.println("HttpServletResponse API : getLocale()");
        if (response != null) {
