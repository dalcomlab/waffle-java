...
import com.dalcomlab.waffle.deployment.descriptor.ListenerDescriptor;

/**
 * @author ByungChang Yoo (dalcomlab@gmail.com)
 */
public class ElementHandlerListener extends ElementHandler {
     ...
     * @throws Exception
     */
    public ElementHandlerListener(Deployment deployment, String namespace) throws Exception {
    ...
    public void handle(XmlParser parser, XmlElement element) {
        ...
        String className = element.getString("listener-class", null);

        if (className == null || className.length() == 0) {
            return;
        }

        ListenerDescriptor listener = deployment.createListener();
        if (listener == null) {
            return;
        }
