 ...
 */
package com.dalcomlab.waffle.resource.jar;
...
public abstract class JarArchive {
     ...
     * @return
     */
    public JarEntry getEntryFromCache(String name) {
     ...
     * @return
     */
    public abstract JarEntry getEntryFromFile(String name);
     ...
     *
     * @return enumeration of the jar file entries
     */
